...
void TowerDefense::Combat::GenerateFights()
{
	...
	const int enemies1[] = { 16, 0, 0, 200, 0, 200, 0, 200 };
	waves->push_back(std::make_shared<Wave>(enemies1, 4));
	pool1.push_back(std::make_shared<Fight>(waves));

	waves = std::make_shared<std::vector<std::shared_ptr<Wave>>>();
	const int enemies2[] = { 16, 0, 5, 100, 5, 100, 5, 100 , 5, 100, 5, 100, 5, 100, 5, 100};
	waves->push_back(std::make_shared<Wave>(enemies2, 4));
	pool1.push_back(std::make_shared<Fight>(waves));

	waves = std::make_shared<std::vector<std::shared_ptr<Wave>>>();
	const int enemies3[] = { 16, 0, 6, 250, 6, 250 };
	waves->push_back(std::make_shared<Wave>(enemies3, 4));
	pool1.push_back(std::make_shared<Fight>(waves));
	...
	waves = std::make_shared<std::vector<std::shared_ptr<Wave>>>();
	const int enemies13[] = { 2, 0, 2, 200, 2, 200, 2, 200, 2, 200 };
	...
	waves->push_back(std::make_shared<Wave>(enemies19, 20));
