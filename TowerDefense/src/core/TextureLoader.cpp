...
void TowerDefense::LoadingScreen::LoadTextures(GLFWwindow* w)
{
    ...
    Load("Goblin",                  enemies.load(6, 0), w);
    Load("GoblinSelected",          enemies.load(7, 0), w);
    Load("Orc ",                    enemies.load(0, 1), w);
    Load("Orc Selected",            enemies.load(1, 1), w);
    Load("Beetle",                  enemies.load(2, 1), w);
    Load("BeetleSelected",          enemies.load(3, 1), w);
    Load("Slime",                   enemies.load(4, 1), w);
    Load("SlimeSelected",           enemies.load(5, 1), w);
    Load("Spider",                  enemies.load(6, 1), w);
    Load("SpiderSelected",          enemies.load(7, 1), w);
    Load("Tough Beetle",            enemies.load(0, 2), w);
    ...
    Load("Shield RatSelected",      enemies.load(3, 3), w);
    Load("ShieldlessRat",           enemies.load(4, 3), w);
    Load("ShieldlessRatSelected",   enemies.load(5, 3), w);
    Load("Shaman Rat",              enemies.load(6, 3), w);
    Load("Shaman RatSelected",      enemies.load(7, 3), w);
    Load("Healer Rat",              enemies.load(6, 3), w);
    Load("Healer RatSelected",      enemies.load(7, 3), w);
    Load("Blink Bug",               enemies.load(0, 4), w);
    Load("Blink BugSelected",       enemies.load(1, 4), w);
    Load("Runner Beetle",           enemies.load(2, 4), w);
    Load("Runner BeetleSelected",   enemies.load(3, 4), w);
    Load("Tank Beetle",             enemies.load(4, 4), w);
    Load("Tank BeetleSelected",     enemies.load(5, 4), w);
    Load("Witch Rat",               enemies.load(6, 3), w);
    Load("Witch RatSelected",       enemies.load(7, 3), w);
    Load("Plague Rat",              enemies.load(6, 4), w);
    Load("Plague RatSelected",      enemies.load(7, 4), w);
    Load("Assassin Rat",            enemies.load(0, 5), w);
    Load("Assassin RatSelected",    enemies.load(1, 5), w);
    Load("Writhing Mass",           enemies.load(2, 5), w);
    Load("Writhing MassSelected",   enemies.load(3, 5), w);
